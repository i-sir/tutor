...
class NotifyController extends AuthController
{
     ...
     * 微信支付回调 测试
     *
     *   test_environment: http://tutor.ikun:9090/api/wxapp/notify/wx_pay_notify_test?pay_num=1000
     *   official_environment: https://xcxkf159.aubye.com/api/wxapp/notify/wx_pay_notify_test?pay_num=1000
    ...
    public function processOrder($pay_num)
    {
        ...
        if ($pay_info['order_type'] == 10) {
            $order_info = $TeacherOrderModel->where($map)->find();//查询订单信息
